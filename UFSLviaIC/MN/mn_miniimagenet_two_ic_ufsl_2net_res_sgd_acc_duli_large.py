...
class Config(object):
    ...
    # matching_net, batch_size, net_name = MatchingNet(hid_dim=64, z_dim=64), 64, "C4"
    matching_net, batch_size, net_name = ResNet12Small(block=BasicBlock, avg_pool=True, drop_rate=0.1), 32, "R12S"
    ###############################################################################################

    model_name = "{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}{}{}".format(
        gpu_id, net_name, train_epoch, batch_size, num_way, num_shot, first_epoch, t_epoch, ic_out_dim, ic_ratio,
    ...
    _root_path = "../models_mn/two_ic_ufsl_2net_res_sgd_acc_duli_large"
