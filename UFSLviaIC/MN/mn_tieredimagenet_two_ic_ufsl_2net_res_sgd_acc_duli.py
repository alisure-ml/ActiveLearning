...
class TieredImageNetDataset(object):
    ...
    def __init__(self, data_list, num_way, num_shot, image_size=84, load_data=False):
    ...
    def train(self):
        ...
        try:
            ...
            for task_data, task_labels, task_index, task_ok in tqdm(self.task_train_loader):
                Tools.print(time.time() - start_time)
                start_time = time.time()
...
class Config(object):
    ...
    _root_path = "../tiered_imagenet/models_mn/two_ic_ufsl_2net_res_sgd_acc_duli"
