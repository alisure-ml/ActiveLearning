...
class Runner(object):
    ...
    def __init__(self):
        ...
        # all data
        self.data_train_list, self.data_val_list, self.data_test_list = ImageNet.get_data_all(Config.data_root)
        self.train_loader = DataLoader(ImageNet(data_list=self.data_train_list, is_train=True),
                                       batch_size=Config.batch_size, shuffle=True,
                                       drop_last=True, num_workers=Config.num_workers)
        self.val_loader = DataLoader(ImageNet(data_list=self.data_val_list, is_train=False),
