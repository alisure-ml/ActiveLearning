...
class Config(object):
    ...
    model_name = "1_{}_{}_{}_{}_{}_{}_{}_{}".format(
        train_epoch, batch_size, num_way, num_shot, ic_out_dim, ic_ratio, loss_fsl_ratio, loss_ic_ratio)
    ...
    _root_path = "../models/two_ic_ufsl_2net_resnet"
