...
class ProduceClass(object):
    ...
    def get_label(self, indexes):
        return cuda(torch.tensor(self.classes[indexes.cpu()]).long())

    pass


class ICRunner(object):

    def __init__(self):
        self.best_acc = 0
        self.train_set, self.train_loader, self.test_set, self.test_loader, self.class_name = CIFAR10Instance.data(
            Config.data_root, batch_size=Config.batch_size)
        self.train_num = self.train_set.__len__()

        self.net = cuda(ICResNet(BasicBlock, [2, 2, 2, 2], Config.low_dim))
        ...
        self.criterion = cuda(nn.CrossEntropyLoss())
    ...
    def _train_one_epoch(self, epoch):
        ...
        try:
            ...
            for batch_idx, (inputs, _, indexes) in enumerate(self.train_loader):
                inputs, indexes = cuda(inputs), cuda(indexes)
                ...
                avg_loss_1.update(loss_cross.item(), inputs.size(0))
                avg_loss_2.update(loss_entropy.item(), inputs.size(0))
                pass

            Tools.print("Train: [{}] {}/{}".format(epoch, self.produce_class.count, self.produce_class.count_2))
            Tools.print('Train: [{}] {} Loss: {:.4f} Loss 1: {:.4f} Loss 1: {:.4f}'.format(
                epoch, len(self.train_loader), avg_loss.avg, avg_loss_1.avg, avg_loss_2.avg))
        finally:
            pass
    ...
    def test(self, epoch=0, t=0.1, loader_n=1):
        _acc = KNN.knn(epoch, self.net, Config.low_dim, self.train_loader, self.test_loader, 200, t, loader_n=loader_n)
        return _acc
...
class_512_1600_64_1
2020-10-24 15:38:20 Test 1 0 Top1=83.44 Top5=99.33
2020-10-24 15:38:47 Test 1 0 Top1=82.34 Top5=99.55
2020-10-24 15:38:47 final accuracy: 83.44

has_entropy = False
2020-10-27 14:42:54 Train: [1599] 14190/2371
2020-10-27 14:42:54 Train: [1599] 782 Loss: 1.2035 Loss 1: 1.2035 Loss 1: 0.2297
2020-10-27 14:43:09 Test 1 1599 Top1=83.45 Top5=99.26
2020-10-27 14:43:09 Test:  [1599] best accuracy: 83.73
2020-10-27 14:43:26 Test 1 0 Top1=83.45 Top5=99.26
2020-10-27 14:43:49 Test 1 0 Top1=82.42 Top5=99.54
2020-10-27 14:43:49 final accuracy: 83.45

has_entropy = True
2020-10-27 13:51:10 Train: [1599] 14351/2532
2020-10-27 13:51:10 Train: [1599] 782 Loss: 1.3914 Loss 1: 1.2222 Loss 1: 0.1692
2020-10-27 13:51:25 Test 1 1599 Top1=83.30 Top5=99.29
2020-10-27 13:51:25 Test:  [1599] best accuracy: 83.65
2020-10-27 13:51:40 Test 1 0 Top1=83.30 Top5=99.29
2020-10-27 13:52:01 Test 1 0 Top1=82.47 Top5=99.56
2020-10-27 13:52:01 final accuracy: 83.30
"""
