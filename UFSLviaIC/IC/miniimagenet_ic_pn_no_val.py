...
class ICProtoNet(nn.Module):
    ...
    def __init__(self, low_dim=512):
        super().__init__()
        self.proto_net = ProtoNet(hid_dim=64, z_dim=64)
...
class Runner(object):
    ...
    def __init__(self):
        ...
        # model
        self.ic_model = self.to_cuda(ICProtoNet(Config.ic_out_dim))
...
"""
1_64_512_1_500_200_0.01.pkl
2020-10-27 05:07:17 Test 2100 .......
2020-10-27 05:07:28 Epoch: 2100 Train 0.3434/0.6677 0.0000
2020-10-27 05:07:28 Epoch: 2100 Val   0.4907/0.8730 0.0000
2020-10-27 05:07:28 Epoch: 2100 Test  0.4731/0.8560 0.0000
"""
...
class Config(object):
    ...
    ic_dir = Tools.new_dir("../models_ic/ic_pn_no_val/{}.pkl".format(model_name))
    pass
