...
class ICRunner(object):
    ...
    def __init__(self):
        ...
        self.produce_class1 = ProduceClass(n_sample=self.train_num, low_dim=Config.low_dim, ratio=Config.ratio)
        self.produce_class2 = ProduceClass(n_sample=self.train_num, low_dim=Config.low_dim, ratio=Config.ratio)
    ...
    def _train_one_epoch(self, epoch):
        ...
        try:
            ...
            for batch_idx, (inputs, _, indexes) in enumerate(self.train_loader):
                ...
                avg_loss_1.update(loss.item(), inputs.size(0))
                pass
            ...
            Tools.print('Train: [{}] {} Loss 1: {:.4f}'.format(epoch, len(self.train_loader), avg_loss_1.avg))
        finally:
            pass
...
class Config(object):
    ...
    resume = False
    pre_train = None
    name = "class_{}_{}_{}_{}".format(low_dim, max_epoch, batch_size, ratio)
